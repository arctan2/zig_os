...
pub const FdtReserveEntryTraverser = struct {
    ...
    pub fn init(fdt_base: [*]u8, fdt_header: *const types.FdtHeader) FdtReserveEntryTraverser {
        ...
        return FdtReserveEntryTraverser{ .base = @ptrCast(@alignCast(start)), .max_count = max_count };
    }

    fn at(self: *FdtReserveEntryTraverser, idx: usize) ?types.FdtReserveEntry {
    ...
    pub fn next(self: *FdtReserveEntryTraverser) ?types.FdtReserveEntry {
